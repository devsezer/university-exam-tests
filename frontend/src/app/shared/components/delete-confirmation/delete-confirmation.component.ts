...
@Component({
  ...
  template: `
    <div *ngIf="show" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
...
export class DeleteConfirmationComponent {
  ...
  @Input() message = 'Bu işlemi geri alamazsınız. Emin misiniz?';
